...
New-ItemProperty -Path "$ChromePolicyRoot\AudioCaptureAllowedUrls" -Name "1" -Value "https://target-tech.fr/*" -PropertyType String -Force | Out-Null

New-Item -Path "$ChromePolicyRoot\VideoCaptureAllowedUrls" -Force | Out-Null
New-ItemProperty -Path "$ChromePolicyRoot\VideoCaptureAllowedUrls" -Name "1" -Value "https://target-tech.fr/*" -PropertyType String -Force | Out-Null
